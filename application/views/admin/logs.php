...
<div class="wrapper">
    ...
    <div class="tabInfoDiv bg-light-custom p-3">
        <div class="tabDiv" tabName="activity">
            ...
            <table class='' id="logstable" data-toggle="table" data-search="true" data-show-export="true" data-buttons-prefix="btn-md btn" data-buttons-align="right" data-pagination="true">
                <thead>
                    <tr>
